...
install_apt_pkg()
{
    apt-get install -y curl file g++ git make libxml-parser-perl libxml-sax-perl openssh-server ruby2.0 ruby2.0-dev uuid-runtime vim dkms build-essential module-assistant
